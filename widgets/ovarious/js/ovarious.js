...
vis.binds['ovarious'] = {
    ...
    jsontemplate2: {
        createWidget: function (widgetID, view, data, style) {
            ...
            if (bound) {
                if (!vis.editMode) {
                    vis.binds['ovarious'].bindStates(
                        $div,
                        bound,
                        vis.binds['ovarious'].jsontemplate2.onChange.bind({
                            widgetID: widgetID,
                            view: view,
                            data: data,
                            style: style,
        ...
        onChange: function (e, newVal /* , oldVal */) {
            if (newVal) {
                vis.binds['ovarious'].jsontemplate2.render(this.widgetID, this.view, this.data, this.style);
            }
        },
